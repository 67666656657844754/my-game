...
# Creating the enemy
enemi = pg.Surface((50, 50))
enemi.fill((255, 0, 0))  # RGB for the red color
...
while running:
    ...
    if pg.Rect(pl_x, pl_y, 55, 55).colliderect(pg.Rect(e_x, e_y, 50, 50)):
        ...
        enemi.fill((255, 0, 0))  # Changes the enemy's color to green upon collision
